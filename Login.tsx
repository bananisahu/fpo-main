      ...
      {page === 1 && (
        <form onSubmit={handleSubmit}>
          <div className={styles.container_register}>
            ...
            <div className={styles.box}>
              <p className={styles.centered}><h5>Enter Your Workspace&nbsp;&nbsp;</h5></p>
              <div><p><br /></p></div>

              <p className={styles.label_login}>
                <label className={styles.label_login}>
                  <input type="text" id="fpoRegistrationNum" name="fpoRegistrationNum" value={formData.fpoRegistrationNum} onChange={handleChange} className={styles.input_field_login} placeholder="FPO Registration Number" />
                </label>
              </p>
              ...
              <p>
                ...
                {message && <p color='#FF0000'>{message}</p>}
              </p>
              <div><p><br /></p></div>
              <p className={styles.label_login}><Link href="/forgotPassword"><h6>Forgot Password</h6></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h6>Forgot Username</h6></p>
            </div>
          </div>
        </form>
